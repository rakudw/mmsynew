...
@section('content')
    ...
    <table class="w100 bordered">
        <caption class="text-center"><strong>AGENDA ITEMS FOR THE DISTRICT LEVEL COMMITTEE (DLC) UNDER MMSY</strong></caption>
        <thead>
            <tr>
                <th scope="col" rowspan="4">#</th>
                <th scope="col" rowspan="4">ID</th>
                <th scope="col" rowspan="4">Name</th>
                <th scope="col" rowspan="4">Address</th>
                <th scope="col" rowspan="4">Unit Address</th>
        ...
        <tbody>
            ...
            @foreach($applications as $application)
                <tr>
                    ...
                    <td>{{ $application->owner_short_address }} </td>
                    ...
                    <td>{{ $application->bank_remarks }}</td>
                </tr>
            @endforeach
        </tbody>
        <tfoot>
