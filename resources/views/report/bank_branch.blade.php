    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-between">
            <div class="align-bottom">
                ...
                <a href="{{ route('report.bank', ['bank' => $bankBranch->bank_id, 'start' => $parameters['period']['start'], 'end' => $parameters['period']['end']]) }}" data-print="#report" data-export-name="Bank Overview" class="btn btn-warning text-dark">
            ...
            <thead>
                <tr>
                    <th scope="col" class="text-center" colspan="6">
                        {{ $bankBranch->ifsc }} - {{ $bankBranch->name }} - {{ $bankBranch->bank->name }}<br />
                    ...
                    @if(count($applications) > 0)
                        ...
                        @foreach($applications as $application)
                            ...
                            <tr>
                                ...
                                <td class="text-end">{{ $application->applicationTimelines->first()->created_at }}</td>
                                <td class="text-end">
