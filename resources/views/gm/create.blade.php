...
@section('title', $title ?? __("GM - New Application"))
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">{{ $title ?? __('GM - New Application') }}</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">{{ $title ?? __('GM - New Application') }}</h6>
    </nav>
@endsection
...
@section('content')
    <div class="row min-vh-80">
        <div class="col-lg-8 col-md-10 col-12 m-auto">
            <h3 class="mt-3 mb-0 text-center">{{ $title ?? __("Add New Application") }}</h3>
