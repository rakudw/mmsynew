...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">{{ $title ?? __('GM') }}</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">{{ $title ?? __('GM') }}</h6>
    </nav>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            @php($items = array(
                                0   => array('name' => 'Pending', 'icon' => 'fas fa-check-circle'),
                                1   => array('name' => 'Approved', 'icon' => 'fas fa-check-double'),
                                2   => array('name' => 'Rejected', 'icon' => 'close')
                                ))
