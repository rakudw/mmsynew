...
@section('title', $title ?? __("GM - Application Preview"))

@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark text-decoration-none" href="{{ route('gm.index') }}">{{ __("GM") }}</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">{{ $title ?? __('GM - Application Preview') }}</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">{{ $title ?? __('GM - Application Preview') }}</h6>
    </nav>
@endsection
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-lg-6 mx-auto">
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-5">
                                    <button class="btn bg-gradient-primary mb-0 mt-lg-auto w-100" type="button" name="button">Approve</button>
                                </div>
                            </div>
                        </div>
                    </div>
