        ...
        <x-table.tr>
            @if(auth()->user()->canScheduleMeeting() && $page == 'schedule')
                ...
                <x-table.td>
                    <form method="POST">
                        ...
                        <textarea class="form-control" name="remarks" placeholder="Remarks for placing before DLC" value="{{ $applicationMeeting ? $applicationMeeting->remarks : '' }}" rows="3"></textarea>
            ...
            <x-table.td class="text-center">
                ...
                @can('update', $application)
                    <a href="{{ route('application.edit', $application->id) }}" class="mx-3 text-decoration-none" data-bs-toggle="tooltip" data-bs-original-title="Edit Application">
                        <em class="material-icons text-secondary position-relative text-lg">drive_file_rename_outline</em>
                    </a>
                @endif
                @can('delete', $application)
                    <a href="{{ route('application.withdraw', $application->id) }}" data-bs-toggle="tooltip" data-bs-original-title="Withdraw Application" class="text-decoration-none">
