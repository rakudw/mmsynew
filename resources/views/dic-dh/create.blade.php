...
@section('title', $title ?? __("DIC - New Application"))
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">{{ $title ?? __('DIC - New Application') }}</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">{{ $title ?? __('DIC - New Application') }}</h6>
    </nav>
@endsection
